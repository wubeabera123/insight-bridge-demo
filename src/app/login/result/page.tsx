...
export default function LoginResultPage() {
  ...
  return (
    <section
      ...
      bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-950 px-4"
    >
      <div
      ...
      >
        <h2 className="text-2xl md:text-3xl font-bold text-center text-[#0B4A97] dark:text-white mb-6">
          Your company doesn’t have an active subscription yet.
        </h2>
        <p className="text-center text-lg text-gray-700 dark:text-gray-400 mb-12">
          Want to get started? Request a Demo below 👇
        </p>

        {/* Request Demo Form (same UI as industries) */}
